...
| Falsification | [`protocols/falsification-protocol.md`](protocols/falsification-protocol.md) | meta (validity axis) | claim-status: *Demarcation at the Claim Level*, *Methodology as Pile-Driver Work*, *Test Mode over Defense Mode*, *Instrument Validation and Test-Material Design*, *The Referent Is the Privileged Falsifier* (+ ten operational tests) |
