...
Falsifiability as criterion; method as anti-ad-hoc selection pressure; methodology itself as pile-driver work, not foundation work. These three commitments shape the three patterns of this discipline.
...
The discipline's patterns translate to seven operational tests applicable to humanities-AI working contexts. They are usable individually; together they form a methodology self-audit pass.
...
| OT-3 | Auxiliary-hypothesis admissibility (per Popper § 20 Regel 1) | Does this added rule / discipline / patch increase what the methodology forbids? | No additional constraint introduced; addition is decoration or face-saving |
...
| OT-5 | Reproducibility before methodology-revision (per Popper § 22) | Is the proposed discipline-revision grounded in a single failure-instance, or in a reproducible pattern? | One-off finding promoted to discipline change without second-instance confirmation |
