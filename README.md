...
- [`protocols/falsification-protocol.md`](protocols/falsification-protocol.md) — meta-level claim-status protocol (validity-axis); the four patterns are *Demarcation at the Claim Level*, *Methodology as Pile-Driver Work*, *Test Mode over Defense Mode*, *Instrument Validation and Test-Material Design*. Provides ten operational tests usable as a methodology self-audit pass.
